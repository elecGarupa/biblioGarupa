              ...
              <div className="flex flex-col items-center gap-6 w-full md:w-1/4 md:border-r border-slate-100 dark:border-slate-700 md:pr-12">
                ...
                >
                  ...
                  {hoverCover && formData.portadaUrl && (
                    <div className="fixed top-1/2 -translate-y-1/2 left-8 z-50 pointer-events-none animate-in fade-in zoom-in-95 duration-200">
                      <div className="w-72 h-96 rounded-2xl overflow-hidden shadow-2xl shadow-slate-900/30 border-2 border-white">
